...
/// let upload = wax::body::content_length_limit(4096)
///     .and(wax::body::aggregate());
/// ```
...
///
/// For example usage, please take a look at [examples/stream.rs](https://github.com/seanmonstar/wax/blob/master/examples/stream.rs).
///
/// # Warning
///
...
/// use wax::{Buf, Filter};
///
/// let route = wax::body::content_length_limit(1024 * 32)
///     .and(wax::body::bytes())
