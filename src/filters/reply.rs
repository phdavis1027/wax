...
//! use wax::Filter;
//!
//! let with_server = wax::reply::with::header("server", "wax");
//!
//! let route = wax::any()
//!     .map(wax::reply)
//!     .with(with_server);
...
// /// let route = wax::any()
// ///     .map(wax::reply)
// ///     .with(wax::reply::with::header("foo", "bar"));
// /// ```
...
// /// let route = wax::any()
// ///     .map(wax::reply)
// ///     .with(wax::reply::with::headers(headers));
// /// ```
...
// /// use wax::Filter;
// ///
// /// // Set `server: wax` if not already set.
// /// let route = wax::any()
// ///     .map(wax::reply)
// ///     .with(wax::reply::with::default_header("server", "wax"));
// /// ```
